...
function TableFilter({tableTeadValues}) {
  ...
  const tableTheme = useTheme([
    ...
    // max-width: 700px;
      ...
      // --data-table-library_grid-template-columns:  10% 22.5% 22.5% 22.5% 22.5%  minmax(100px, 1fr) !important ;
        ...
        --data-table-library_grid-template-columns: 50px repeat(3, minmax(150px, auto));
            ...
            <>
              <Header>
                <HeaderRow>
                  ...
                  {
                    tableTeadValues.map(tbValue=>(
                  <HeaderCell>{tbValue}</HeaderCell>

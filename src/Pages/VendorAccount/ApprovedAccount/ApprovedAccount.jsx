...
function ApprovedAccount() {
  ...
  return (
    <div >
      <div className="vd-pending-title">Approved Vendor Accounts</div>
        ...
        <Table data={businesses} theme={tableTheme}>
          {(tableList) => (
            <>
              <Header>
                <HeaderRow>
                  <HeaderCell><input type="checkbox"  /></HeaderCell>
              ...
              <Body>
                {tableList.map((item) => (
                  <Row key={item.id} item={item}>
                    ...
                    <Cell>{item.businessInfo.yearsInOpertion} {item.businessInfo.yearsInOpertion && "years"}</Cell>
                    <Cell>
                      {" "}
                      <button
                        className="status-btn-st"
                        onClick={() =>
                          navigate("/vendor-account/Pending-Account/details/1")
                        }
                      >
                        Approved
                      </button>{" "}
